...
#ifndef SST_PUBLIC_RED_BLACK_TREE_H_
#define SST_PUBLIC_RED_BLACK_TREE_H_
...
typedef struct rb_red_blk_node {
  ...
  struct rb_red_blk_node* prev;
  struct rb_red_blk_node* next;
...
rb_red_blk_tree* RBTreeCreate( rb_red_blk_tree* newTree,
...
#endif /* SST_PUBLIC_RED_BLACK_TREE_H_ */
